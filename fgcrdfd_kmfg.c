...
//      fgcrdfd(inp, tmaxz, xbc, ybc, bs, tdini, tkini, wgt_flg, &tdest, &tkest);
  ...
  /***** 誤差分析 *****/
//  err_anal(d_est, model, xs, ys, bp, bs, exblk, t_e, fullbase, outbase);
//  tilt_anal(d_est, model, max_z, preinp, xs, ys, bp, bs, exblk, t_e, t_d, outbase);
//  tilt_anal(d_est, model, max_z, inp, xs, ys, bp, bs, exblk, t_e, t_d, outbase);
